...
def multiplis():
    ...
    def mul1x1():
        ...
        a = input(f'Введите первый тензор через пробел размерность - {R}: ')
        a = parse(a)
    ...
    def mul1x3():
        ...
        a = input(f'Введите второго тензор через пробел размерность - {R}x{R} (по строкам в одну линию): ')
        a = parse(a)
        mas2 = arange(R*R)
        for i in range (R*R):
            mas2[i] = a[i]
    ...
    def mul3x1():
        ...
        a = input(f'Введите первый тензор через пробел размерность - {R}x{R} (по строкам в одну линию): ')
        a = parse(a)
        mas2 = arange(R*R)
        for i in range (R*R):
            mas2[i] = a[i]
        ...
        mas1 = []
        a = input(f'Введите второй тензор через пробел размерность - {R}: ')
        a = parse(a)
        for i in range (R):
            mas1.append(a[i])
        print(mas1)
